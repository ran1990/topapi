...
class AlibabaAlscUnionElemePromotionItempromotionQueryItemPromotionDto {
    ...
    public function getTicket() : AlibabaAlscUnionElemePromotionItempromotionQueryItemTicket{
        return $this->ticket;
    }

    public function setTicket(AlibabaAlscUnionElemePromotionItempromotionQueryItemTicket $ticket){
        $this->ticket = $ticket;
    }
